...
namespace MyTamagotchiAPI.Controllers
{
    ...
    public class PetsController : ControllerBase
    {
        ...
        public async Task<ActionResult<Pet>> PlayTimeForPet(int id)
        {
            ...
            _context.Playtimes.Add(petPlayTime);
            await _context.SaveChangesAsync();

            return Ok(petPlayTime);
        ...
        public async Task<ActionResult<Pet>> FeedingForPet(int id)
        {
            ...
            _context.Feedings.Add(petFeeding);
            await _context.SaveChangesAsync();

            return Ok(petFeeding);
